      ...
      items: [
        {
          ...
          desc: "CBT & mindfulness to reduce worry, rumination, and panic.",
        },
        {
          title: "Depression",
          desc: "Behavioral activation and values-based interventions.",
        },
        {
          title: "Burnout & Work",
          desc: "Boundaries, resilience, and sustainable routines.",
        },
        {
          title: "Grief & Loss",
          desc: "Compassionate space to process and integrate.",
        },
        {
          title: "Life Transitions",
          desc: "Support through relocation, parenthood, separation.",
        },
        {
          title: "Couples (Brief)",
          desc: "Communication tools and conflict de-escalation.",
        },
      ],
    },
    about: {
      title: "About Dr. Florencia Ferrandino Lamarca",
      p1: "Licensed psychologist (PhD, University of Barcelona). 10+ years helping adults using CBT, ACT, and compassion-focused therapy. Registered with COPCV.",
      p2: "I believe change happens in a safe, collaborative space. We’ll set clear goals, track progress, and build practical skills you can use between sessions.",
      stats: {
  ...
  es: {
    ...
    services: {
      ...
      items: [
        ...
        {
          title: "Depresión",
          desc: "Activación conductual e intervenciones basadas en valores.",
        },
        {
          title: "Burnout y Trabajo",
          desc: "Límites, resiliencia y rutinas sostenibles.",
        },
        {
          title: "Duelo y Pérdida",
          desc: "Espacio compasivo para procesar e integrar.",
        },
        {
          title: "Transiciones Vitales",
          desc: "Apoyo en mudanzas, maternidad/paternidad, separaciones.",
        },
        {
          title: "Pareja (breve)",
          desc: "Herramientas de comunicación y desescalada del conflicto.",
        },
      ],
    },
    about: {
    ...
    approach: {
      ...
      steps: [
        ...
        },
        {
          step: "02",
          title: "Evaluación",
          text: "En 1–2 sesiones mapeamos patrones y objetivos.",
        },
        {
          step: "03",
          title: "Intervención",
          text: "Sesiones semanales + prácticas breves en casa.",
        },
      ],
    },
    testimonials: {
    ...
    contact: {
      ...
      form: {
        ...
        message: "Mensaje",
        send: "Enviar",
        disclaimer: "Al enviar aceptas ser contactad@ para agendar.",
      },
    },
